...
@section('pageTitle', 'Task Manager - Register')
@section('pageContent')

		<main class="flex min-h-screen flex-col items-center justify-center bg-gray-50 p-4 dark:bg-gray-900">
				...
				<form class="form-wrapper">
						...
						<a href="{{ route('login') }}" class="nav-link mt-5">Already have an account? Login</a>
