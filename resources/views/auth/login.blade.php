		...
		<main class="p-4 flex min-h-screen flex-col items-center justify-center bg-gray-50 dark:bg-gray-900">
				...
				<form class="form-wrapper">
						...
						<div class="my-3 flex items-center justify-center gap-3">
								<a href="#" class="outline-btn">
										<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1"
												x="0px" y="0px" viewBox="0 0 24 24" style="enable-background:new 0 0 24 24;" xml:space="preserve" width="25"
												height="25">
												<g>
						...
						<div class="space-x-2 text-center">
								<a href="{{ route('forgot-password') }}" class="nav-link mt-5">forgot password</a>
								<a href="{{ route('register') }}" class="nav-link mt-5">Create account</a>
						</div>
