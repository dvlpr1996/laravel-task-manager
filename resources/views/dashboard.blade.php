...
<section class="xs:grid-cols-2 grid gap-3 sm:grid-cols-4">
		<div class="border rounded-xl p-5 bg-gray-200 dark:bg-gray-800 border-gray-300 dark:border-gray-800">
...
<section>
		<div class="space-y-3 rounded-xl bg-gray-100 p-5 dark:bg-gray-800 border border-gray-200 dark:border-gray-800">
