...
@section('pageTitle', 'Task Manager - Inbox')
@section('main-content')

		<section class="space-y-8 md:space-y-5">
				...
				<div class="flex items-center justify-center gap-2 capitalize">
						<img src="{{ asset('img/laravel-task-manager.png') }}" alt="Laravel Task Manager"class="rounded-full w-12 h-12"
								loading="lazy">
